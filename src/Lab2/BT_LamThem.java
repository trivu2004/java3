...
public class BT_LamThem extends JFrame implements ActionListener {
    ...
    Object[][] data = {
        {"1", "Tri", "08-05-2004", "Male", "Soccer,Watching"},
        {"2", "Dung", "05-02-2004", "Male", "Soccer,Watching"},
        {"3", "Thuan", "01-10-2004", "Male", "Soccer,Watching"}
    };
    
    String[] column = new String[]{"Id", "Name", "BirthDay", "Gender", "Hobbies"};
    ...
    public BT_LamThem() {
        ...
        p19 = new JPanel();
        p19.setBounds(100, 700, 900, 205);
        model = new DefaultTableModel();
        tblDangKi = new JTable(data, column);
        tblDangKi.setFont(new Font("Serif", Font.BOLD, 17));
        JTableHeader header = tblDangKi.getTableHeader();
        Font font = new Font("Serif", Font.BOLD, 20);
        header.setFont(font);
        header.setForeground(Color.red);
        tblDangKi.setPreferredScrollableViewportSize(new Dimension(600, 120));
    ...
    public void filltable() {
        model.setRowCount(0);
        for (Data data : list) {
            Object[] row = new Object[]{list.indexOf(data)+1,data.getFullname(), data.getBirthday(), data.getGender(), data.getHobbies()};
            model.addRow(row);
        }
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(click.equalsIgnoreCase("Save")){
            ...
            dt.setFullname(txtName.getText()+txtLastname.getText());
            dt.setBirthday(lblBirthday.getText());
            if(jdbtSex1.isSelected()==true){
                dt.setGender(jdbtSex1.getText());
            }else if(jdbtSex2.isSelected() == true){
                dt.setGender(jdbtSex2.getText());
            }else{
                dt.setGender(jdbtSex3.getText());
            }
            String str = "";
